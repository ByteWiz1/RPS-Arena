...
export default function TrainingScreen() {
  ...
  const handleSave = () => {
    if (!avatar) {
      Alert.alert('No Avatar', 'Create an avatar first');
      return;
    }
    updateAvatarPersonality(avatar.id, personality);
    setHasChanges(false);
    Alert.alert('Saved', 'Your AI has been tuned!');
  };
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        ...
        <TouchableOpacity
          style={styles.simulationCard}
          onPress={() => Alert.alert('Coming Soon', 'Blitz Test arrives in the next update')}
        >
        ...
        <TouchableOpacity
          style={styles.simulationCard}
          onPress={() => Alert.alert('Coming Soon', 'Pattern Drill arrives in the next update')}
        >
...
const styles = StyleSheet.create({
  ...
  avatarHeader: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 16, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)' },
  avatarEmoji: { fontSize: 40 },
  avatarInfo: { flex: 1 },
  avatarName: { fontSize: 18, fontWeight: '700', color: '#ffffff' },
  avatarLevel: { fontSize: 13, color: '#e94560', marginTop: 2 },
  sectionTitle: { fontSize: 13, fontWeight: '600', color: '#5a5a7a', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 8, marginBottom: 10 },
  sliderCard: { backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)' },
  ...
  previewCard: { backgroundColor: 'rgba(233, 69, 96, 0.08)', borderRadius: 12, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: 'rgba(233, 69, 96, 0.2)' },
  ...
  presetButton: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.03)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  ...
  saveButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#e94560', padding: 14, borderRadius: 12, marginBottom: 20 },
  saveButtonDisabled: { backgroundColor: 'rgba(74, 222, 128, 0.2)' },
  saveButtonText: { color: '#ffffff', fontSize: 16, fontWeight: '600' },
  simulationCard: { flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 14, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)' },
