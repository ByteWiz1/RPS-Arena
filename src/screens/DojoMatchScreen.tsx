      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            <Text style={styles.headerTitle}>{master.emoji} {master.name}</Text>
            <Text style={styles.headerSubtitle} numberOfLines={1}>First to {ROUNDS_TO_WIN}</Text>
          </View>
        ...
        <ScreenScroll contentStyle={styles.scrollContent} headerHeight={70}>
          ...
          <View style={styles.moveDisplay}>
            ...
            <View style={styles.moveItem}>
              ...
              <View style={styles.moveCircle}>
                <Text style={styles.moveIcon}>{aiMove ? MOVE_ICONS[aiMove] : '❓'}</Text>
              </View>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  matchOverArea: { alignItems: 'center', paddingVertical: 20, gap: 10 },
  matchOverEmoji: { fontSize: 56 },
  matchOverTitle: { fontSize: 30, fontWeight: '800' },
  matchOverWin: { color: '#4ade80' },
  matchOverLose: { color: '#f87171' },
  matchOverReward: { fontSize: 13, color: '#fbbf24', fontWeight: '700', marginTop: 4 },
  matchOverButtons: { flexDirection: 'row', gap: 10, marginTop: 16 },
  primaryBtn: { backgroundColor: '#e94560', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 12 },
  primaryBtnText: { color: '#ffffff', fontSize: 14, fontWeight: '700' },
  secondaryBtn: { backgroundColor: 'rgba(255,255,255,0.06)', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 12 },
  secondaryBtnText: { color: '#8a8a9a', fontSize: 14, fontWeight: '700' },
