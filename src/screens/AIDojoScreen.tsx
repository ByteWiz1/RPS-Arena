...
const MASTERS: Master[] = [
  ...
  },
  {
    ...
    emoji: '😤',
    rating: 1400,
    tagline: 'I know what you will do.',
    rewardXP: 50,
    rewardRating: 20,
    difficulty: 'hard',
    color: '#e94560',
  },
  {
    ...
    emoji: '🧠',
    rating: 2000,
    tagline: 'Defeat Hunter to face me.',
    rewardXP: 100,
    rewardRating: 50,
    difficulty: 'expert',
    color: '#a78bfa',
        ...
        <View style={styles.progressCard}>
          ...
          <View style={styles.progressBar}>
            <View
              style={[
                styles.progressFill,
                { width: `${(defeated.length / MASTERS.length) * 100}%` },
              ]}
            />
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  introCard: { backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 16, padding: 20, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)' },
  introTitle: { fontSize: 20, fontWeight: '700', color: '#ffffff', marginBottom: 4 },
  introSubtitle: { fontSize: 13, color: '#5a5a7a', lineHeight: 18 },
  progressCard: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: 'rgba(251, 191, 36, 0.08)', borderRadius: 12, padding: 14, marginBottom: 20, borderWidth: 1, borderColor: 'rgba(251, 191, 36, 0.2)' },
  ...
  masterCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 16, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)' },
  ...
  championCard: { alignItems: 'center', backgroundColor: 'rgba(251, 191, 36, 0.1)', borderRadius: 16, padding: 24, marginTop: 12, borderWidth: 1, borderColor: 'rgba(251, 191, 36, 0.3)' },
